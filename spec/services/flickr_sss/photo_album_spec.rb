...
<photo id=\"15747759221\" url_o=\"original_url\" owner=\"40201685@N00\" secret=\"439322c1b6\" server=\"7471\" farm=\"8\" title=\"20141107_M2_35-1.2_FP4_HC110B_18_web\" ispublic=\"1\" isfriend=\"0\" isfamily=\"0\" />\n\t
<photo id=\"15749645845\" url_z=\"zed_url\" owner=\"40201685@N00\" secret=\"e2d9f9c74e\" server=\"3955\" farm=\"4\" title=\"20141107_M2_35-1.2_FP4_HC110B_35_web\" ispublic=\"1\" isfriend=\"0\" isfamily=\"0\" />\n\t
<photo id=\"15563878849\" url_m=\"medium_url\"\ owner=\"127393233@N05\" secret=\"91374e0959\" server=\"8417\" farm=\"9\" title=\"TEST MARKER 2\" ispublic=\"1\" isfriend=\"0\" isfamily=\"0\" originalsecret=\"2c38653b45\" originalformat=\"jpg\" />\n\t
...
<rsp stat=\"ok\">\n
  ...
  it "builds the urls for each image when asked to" do
    album = FlickrSss::PhotoAlbum.new body, build_urls: true
    photo = album.photos[2]
  ...
  it "sets the url of the largest image for each photo" do
    album = FlickrSss::PhotoAlbum.new body
    expect(album.photos.first["url_large"]).to eq "original_url"
    expect(album.photos[1]["url_large"]).to eq "zed_url"
    expect(album.photos[2]["url_large"]).to eq "medium_url"
  end
